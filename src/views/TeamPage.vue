        ...
        <v-row>
            ...
            <v-col md="6" sm="6" class="mt-5 left-p-mar">
                <v-card class="mx-auto pa-12 pb-5 rounded" 
                        ...
                        style="background:#B9D9EB"
                >
                    <v-img :src="aescobar_pfp"/>
                    <v-card-title style="font-size: 24px;" class="pl-0 text-f">Aescobar
                        <v-btn
                            class="mx-3"
                            small
                            dark
...
import aescobar_pfp from "../assets/TeamPage/aescobar_pfp.png"
export default {
    data: () => ({
        huge_pfp: huge_pfp,
        akz_pfp: akz_pfp, 
        pro_pfp: pro_pfp,
        aescobar_pfp: aescobar_pfp,
    }),
}
</script>
<style scoped>
